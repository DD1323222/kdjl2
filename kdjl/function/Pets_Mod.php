...
if (is_array($bag))
{
	...
	$alltakeoff = '<h2><input style="position:absolute;left:90px;top:255px;" type="button" value="秒脱" onclick="alltakeoff('.$petAllPid.','.$pd['id'].','.$petAllUserPid.')" /><input style="position:absolute;left:232px;top:255px;" type="button" value="秒穿" onclick="alltakeon('.$pd['id'].')" /></h2>';
}
